<p align="center">
  <img src="../res/logo-header.svg" alt="Telemost - desktopul tău la distanță"><br>
  ...
  <b>Avem nevoie de ajutorul tău pentru a traduce acest README, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">Telemost UI</a> și <a href="https://github.com/rustdesk/doc.rustdesk.com">Telemost Doc</a> în limba ta maternă</b>
</p>

> [!Atenție]
> **Declinare de responsabilitate privind utilizarea abuzivă:** <br>
> Dezvoltatorii Telemost nu susțin sau aprobă utilizarea neetică sau ilegală a acestui software. Utilizarea abuzivă, cum ar fi accesul neautorizat, controlul sau invadarea intimității, este strict împotriva regulilor noastre. Autorii nu sunt responsabili pentru utilizarea necorespunzătoare a aplicației.


Conversați cu noi: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/telemost) | [Reddit](https://www.reddit.com/r/telemost) | [YouTube](https://www.youtube.com/@telemost)

[![Telemost Server Pro](https://img.shields.io/badge/Telemost%20Server%20Pro-Advanced%20Features-blue)](https://rustdesk.com/pricing.html)
...
Telemost primește contribuții de la oricine. Vezi [CONTRIBUTING.md](../docs/CONTRIBUTING.md) pentru ajutor la început.
...
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/rustdesk/tree/master/src/rendezvous_mediator.rs)**: comunică cu [telemost-server](https://github.com/rustdesk/rustdesk-server), așteaptă conexiune directă remote (TCP hole punching) sau prin relay
