...
///
/// Note:
/// On linux, we use dbus to communicate between multiple telemost processes.
...
const DBUS_NAME: &str = "org.telemost.telemost";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "Telemost DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.telemost.telemost /dbus org.telemost.telemost.NewConnection string:'PEER_ID'`
