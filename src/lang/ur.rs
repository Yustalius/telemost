...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "زبان"),
        ("Keep Telemost background service", "Telemost پس منظر کی خدمت کو برقرار رکھیں"),
        ...
        ("Show Telemost", "Telemost دکھائیں"),
        ("This PC", "یہ PC"),
        ("or", "یا"),
        ("Elevate", "علیٰ کریں"),
        ...
        ("upgrade_telemost_server_pro_to_{}_tip", ""),
        ...
        ("About Telemost", "رستڈیسک کے بارے میں"),
        ...
        ("upgrade_remote_telemost_client_to_{}_tip", ""),
        ("d3d_render_tip", ""),
