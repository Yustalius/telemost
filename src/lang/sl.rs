...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem Telemost..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, Telemost v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate Telemostu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate Telemostu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno Telemostu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »Telemost Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep Telemost background service", "Ohrani Telemostovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije Telemost, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "Telemost potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "Telemost potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_telemost_password_tip", "Preveri geslo za Telemost"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite Telemost, prekinite klic in program zaprite."),
        ("scam_text2", "Telemost omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_telemost_server_pro_to_{}_tip", "Prosimo, nadgradite Telemost Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo Telemost"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno Telemosta odprto"),
        ...
        ("floating_window_tip", "Pomaga pri Telemost storitvi v ozadju"),
        ...
        ("upgrade_remote_telemost_client_to_{}_tip", "Prosimo, nadgradite Telemost odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto Telemost preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo Telemost ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, Telemost ne bo več uporabljal UDP 21116, namesto tega bo uporabljen TCP 21116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik Telemost OSS ne vključuje te funkcije."),
