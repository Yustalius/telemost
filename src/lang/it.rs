...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete Telemost..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), Telemost potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare Telemost a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a Telemost il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a Telemost il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a Telemost di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [Telemost Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep Telemost background service", "Mantieni il servizio di Telemost in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione Telemost, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show Telemost", "Visualizza Telemost"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a Telemost 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a Telemost."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di Telemost."),
        ...
        ("verify_telemost_password_tip", "Conferma password Telemost"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare Telemost e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_telemost_server_pro_to_{}_tip", "Aggiorna Telemost Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di Telemost come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da Telemost"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra Telemost è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio Telemost in background."),
        ...
        ("About Telemost", "Info su Telemost"),
        ...
        ("upgrade_remote_telemost_client_to_{}_tip", "Aggiorna il client Telemost remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, Telemost verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, Telemost salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, Telemost non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server Telemost non include questa funzionalità."),
