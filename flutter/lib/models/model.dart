...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsTelemostVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsTelemostVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsTelemostVirtualDisplays);
        }
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get TelemostVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsTelemostVirtualDisplays] ?? []);
  ...
  bool get isTelemostIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'telemost_idd';
